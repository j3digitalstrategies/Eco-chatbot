        ...
        if os.path.exists(ZIP_PATH):
            try:
                ...
                if found_path:
                    ...
                    return "Ready"
                return "Error: DB not found in zip"
            except Exception as e:
                return f"Zip Error: {e}"
        return "Error: chroma_db.zip missing"
    return "Ready"
...
cols = st.columns(3)
quick_prompts = ["What is the waste module?", "Tell me about recycling", "Eco-friendly tips"]
...
if st.session_state.get("active_query"):
    final_query = st.session_state.active_query
